<# 
    WinUIIslands Patch: replaces auto-generated UWP Application.Start in
    App.g.i.cs with WinUIIslands's XAML Islands initialization.
#>
...
$replacement = @"
// WinUIIslands Patch: replaced UWP Application.Start with XAML Islands init.
